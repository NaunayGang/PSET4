...
class Incident:
    ...
    def escalateIncident(self) -> None:
    ...
    def triageIncident(self, priority: Severity) -> None:
    ...
    def assignIncident(self, user_id: int) -> None:
    ...
    def inProgressIncident(self) -> None:
    ...
    def changeSeverity(self, new_severity: Severity) -> None:
        if self.state in [State.CLOSED, State.CANCELLED]:
